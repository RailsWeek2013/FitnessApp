...
class UserDataControllerTest < ActionController::TestCase
  ...
  test "should create user_datum" do
    assert_difference('UserDatum.count') do
      post :create, user_datum: { birthday: @user_datum.birthday, bodysize: @user_datum.bodysize, firstname: @user_datum.firstname, lastname: @user_datum.lastname, sex: @user_datum.sex, weight: @user_datum.weight }
    end
  ...
  test "should update user_datum" do
    patch :update, id: @user_datum, user_datum: { birthday: @user_datum.birthday, bodysize: @user_datum.bodysize, firstname: @user_datum.firstname, lastname: @user_datum.lastname, sex: @user_datum.sex, weight: @user_datum.weight }
    assert_redirected_to user_datum_path(assigns(:user_datum))
  end
